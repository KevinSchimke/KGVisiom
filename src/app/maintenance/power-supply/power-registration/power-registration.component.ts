...
@Component({
  selector: 'app-power-registration',
  standalone: true,
  templateUrl: './power-registration.component.html',
  styleUrl: './power-registration.component.scss',
...
export class PowerRegistrationComponent {
...
register() {
  if (this.registerForm.valid) {
    ...
    this.http.post('https://backend.kgv.local:8443/api/power/register', payload)
      .subscribe({
        next: () => {
